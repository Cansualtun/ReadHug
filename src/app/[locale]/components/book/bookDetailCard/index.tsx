...
export default function BookDetailCard({ book }: BookDetailCardProps) {
    return (
        <Card className="bg-gradient-to-r from-gray-50 to-white shadow-xl">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="relative">
                            ...
                            <div className="absolute top-3 right-3 flex gap-2">
                                <Button isIconOnly variant="flat" className="bg-white/70 backdrop-blur-md">
                                    <Heart className={`w-5 h-5 ${book.isFavorite ? 'fill-red-500 text-red-500' : 'text-gray-700'}`} />
                                </Button>
                                <Button isIconOnly variant="flat" className="bg-white/70 backdrop-blur-md">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        <div>
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                <p className="text-xl text-gray-600">{book.bookId.author.name}</p>
                                <span className="text-gray-400">•</span>
                                <p className="text-gray-600">{book.bookId.publisher.name}</p>
                            </div>
                        </div>
                        ...
                        <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-none">
                            <CardBody className="p-6">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <p className="text-2xl font-bold text-blue-600">{book.process.percent}%</p>
                                </div>
                                <Progress
